...
//   보였다. 여러 간격(50/60/70/80/98)을 나란히 놓고 비교해서, 62 정도가
//   "테두리끼리 딱 붙거나 아주 살짝 겹치는" 수준이라 이 값으로 재조정.
...
//   배치되는 것을 막기 위한 여백.
const PLACEMENT = { pathMargin: 68, maxPathDistance: 135, towerSpacing: 62, playTop: 64, playBottom: 650, edgeMargin: 34 };
